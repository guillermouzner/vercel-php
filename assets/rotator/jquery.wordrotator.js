		...
		return this.each(function(){
			...
			if ((settings.words) || (settings.words instanceof Array)) {
				...
				var rotate = function() {
					...
					cont.find(".wordsrotator_wordOut").addClass("animate__animated " + settings.animationOut);
					cont.find(".wordsrotator_wordIn").addClass("animate__animated " + settings.animationIn);
				};
