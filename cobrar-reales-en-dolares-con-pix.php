        ...
        <div class="container">
            ...
            <nav class="navigation">
                <ul class="navigation__primary">
                    <li><a href="cobrar-reales-en-dolares-con-pix.php" class="active">Qué es kamiPay</a></li>
        ...
        <div class="container2">
            <div class="hero-internal__grid">
                <div class="hero-internal__content">
                    <h1 class="hero-internal__title">¿Cómo cobrar PIX en Argentina con kamiPay?</h1>
                ...
                <div class="hero-interal__image">
                    <img src="assets/images/que-es/hero.webp" srcset="assets/images/que-es/hero.webp 1x, assets/images/que-es/hero@2x.webp 2x, assets/images/que-es/hero@2x.webp 3x" width="371" height="257" alt="¿Cómo cobrar PIX en Argentina con kamiPay?">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container2">
        ...
        <div class="operar__grid">
            <div class="operar__column">
                ...
                <figure><span class="link show-presencial"><img src="assets/images/que-es/pix-presencial.webp" width="236" height="459" alt="Presencial"></span></figure>
...
<section class="contacto contacto-quees">
    <div class="container2">
        <div class="contacto-quees__content">
            ...
            <a href="https://calendly.com/juancruz-kamipay/30min" target="_blank" class="btn">
    ...
    <div class="modal-center">
        ...
        <div class="modal-body">
            ...
            <video width="320" height="240" controls class="modal-video" id="video2">
                <source src="assets/videos/tutorial-kamipay.mp4" type="video/mp4">
            </video>
            </div>
        </div>
    </div>
        ...
        <div class="modal-body">
            <div class="video-wrapper">
                <video width="320" height="240" controls class="modal-video" id="video3">
                    <source src="assets/videos/link-de-pago-kamipay.mp4" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
